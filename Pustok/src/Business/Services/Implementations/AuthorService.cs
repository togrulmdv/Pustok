...
public class AuthorService : IAuthorService
{
    ...
    {
        var authors = await _authorRepository.GetFiltered(a => search != null ? a.Fullname.Contains(search) : true).ToListAsync();
    ...
    {
        var author = await _authorRepository.GetSingleAsync(a => a.Id == id);
        if (author is null)
